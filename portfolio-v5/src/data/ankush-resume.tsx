...
export const DATA = {
  ...
  skills: ["React", "Next.js", "Typescript", "Node.js", "Python", "Java"],
  navbar: [
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/AnkushUdapure",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ankush-udapure-b61882220/",
        icon: Icons.linkedin,
  ...
  work: [
    {
      company: "Kaliba Enterprises",
      href: "https://www.kalibaenterprises.com/",
      badges: [],
      location: "Remote",
