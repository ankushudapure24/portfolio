...
export function ProjectCard({
  ...
  return (
    <Card
      className={
        "flex flex-col m-6 lg:w-full sm:w-320px  max-w-[400px] overflow-hidden border hover:shadow-lg backdrop-blur-lg hover:border-gray-400 rounded-2xl transition-all duration-300 ease-out h-full "
      }
    >
